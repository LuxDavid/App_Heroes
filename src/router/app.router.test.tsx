...
vi.mock('@/admin/pages/heroes/layouts/HeroesLayout', () => ({
    HeroesLayout: () => <div data-testid="heroes-layout">
        <Outlet/>
    </div>
}));

vi.mock('@/admin/pages/heroes/pages/home/HomePage', () => ({
    HomePage: () => <div data-testid="home-page"></div>
}));

vi.mock('@/admin/pages/heroes/pages/hero/HeroPage', () => ({
    HeroPage:() => {
...
vi.mock('@/admin/pages/heroes/pages/search/SearchPage', () => ({
...
describe('appRouter', () => {
    ...
    test('should render hero page at /heroes/:idSlug path', () => {
        ...
        // screen.debug();
        expect(screen.getByTestId('hero-page').innerHTML).toContain('HeroPage - superman');
    });
