...
import AxiosMockApater from 'axios-mock-adapter';
...
describe('getHeroesByPageAction', () => {
    ...
    const heroesApiMock = new AxiosMockApater(heroApi);
    ...
    test('should return the correct heroes whenpage is not a number', async () => {
    ...
    test('should return the correct heroes whenpage is string number', async () => {
